...
exports.keyWasPressed = (e, code) ->
    if window.event
        window.event.keyCode is code
    else e.which is code

exports.cursorUpdater = (cursor, element) ->
    (e) ->
        x = y = 0
        ...
        p = exports.findElementPosition element
        cursor[0] = x - element.offsetLeft - p.x
        cursor[1] = y - element.offsetTop  - p.y

exports.findElementPosition = (obj) ->
    if obj.offsetParent
        curleft = curtop = 0
        loop
...
exports.Vector2Pool = class extends exports.ObjectPool
    constructor: (count) ->
        super count,
        -> new Float32Array 2,
        (v) ->
